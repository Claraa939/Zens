...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "fileName": 'Creαted by : Claraa - Kawai ♡',
  ...
  }}, 'buttonsMessage', { quoted: false, contextInfo: { mentionedJid: [user], forwardingScore: 999, isForwarded: true, externalAdReply: { title: global.wm, body: action === 'add' ? 'Selamat Datang Kak!' : 'Yahh.. kok keluar :‹', description: action === 'add' ? 'Selamat Datang Kak!' : 'Yahh.. kok keluar :‹', mediaType: 2, thumbnail: action === 'add' ? wel : lea, mediaUrl: `https://wa.me/message/P56KIJQXBWZ6H1`}}})
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, '🤖 Zens вσт', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
`.trim(), '🎮 Zens вσт', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
...
let fot = `Made by @${'6288971419677'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": `MY OWNER`,
                                         "description": "List Owner Zens BOT",
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `ABOUT`,
                                         "description": " Tentang Zens BOT", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `LIST MENU`,
                                         "description": " List Menu Zens BOT",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `SCRIPT`,
                                         "description": " Source code Zens BOT",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `GROUP BOT`,
                                         "description": " List Group Official Zens BOT",
                                         "rowId": ".gcbot"
                       }],
                    "title": "Created By Clara - WIBU ♡"
                  }
                        ], "contextInfo": 
                         { "stanzaId": m.key.id,
